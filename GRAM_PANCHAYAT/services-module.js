...
class ServicesModule {
    ...
    async bulkImportServices(servicesData) {
        try {
            ...
            this.logger.info('Bulk import completed', { count: serviceIds.length });
            return serviceIds;
        } catch (error) {
            this.logger.error('Failed to bulk import services', { error: error.message });
            throw error;
        }
    }
     ...
     */
    async getServicesPaginated(limit = 10, lastDoc = null) {
        try {
            ...
            this.logger.error('Failed to get paginated services', { error: error.message });
            throw error;
        }
    }
}
